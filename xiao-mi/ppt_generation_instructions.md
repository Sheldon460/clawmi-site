# 使用子 Agent 生成 PPT 图片的指令

由于主 Agent 的图片生成遇到网络限制，我们将使用独立的子 Agent 来生成图片。

## 任务说明

为 **OpenClaw 云端部署与培养指南** 生成 15 张 PPT 图片。
...
### 第 1 页：封面
```
标题：OpenClaw 云端端署与培养指南
副标题：从零到一构建企业级 AI 助手平台
构图：中心放置巨大的复杂3D玻璃物体，覆盖粗体大字
背景：延伸的极光波浪
```
...
- 宽高比：16:9
- 分辨率：1024x576 (2K) 或 1920x1080 (4K)
- 格式：PNG
- 文件命名：slide-01.png, slide-02.png, ..., slide-15.png

## 输出要求

请将生成的 15 张图片保存到：
`/Volumes/My house/Users/Sheldon/.openclaw/workspace/xiao-mi/ppt_images/`
