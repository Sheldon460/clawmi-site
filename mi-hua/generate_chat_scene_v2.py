...
try:
    ...
    font_name = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", 14)
    font_message = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", 15)
...
# 标题
draw.text((width//2 - 70, 35), "Product Group", fill=text_dark, font=font_title)
...
msg1_y = 100
# 头像 (左侧)
draw_avatar(draw, 15, msg1_y, 40, '#FF6B6B', "PM", font_name)
# 名字
draw.text((60, msg1_y - 5), "Product Manager", fill=text_gray, font=font_small)
# 消息气泡
msg1_w = 280
msg1_h = 40
...
# @高亮
draw.text((72, msg1_y + 22), "@Molili", fill=blue_at, font=font_message)
draw.text((140, msg1_y + 22), " analyze user feedback", fill=text_dark, font=font_message)
...
draw.text((width - 60 - msg2_w + 12, msg2_y + 30), msg2_text, fill=text_dark, font=font_message)
...
msg3_lines = [
    "Analysis Complete:",
    "",
    "1. Issue: Login too complex",
    "2. Impact: ~30% new users",
    "3. Suggest: Simplify flow",
    "",
    "Report ready. Send?"
]
...
# 头像 (左侧)
draw_avatar(draw, 15, msg4_y, 40, '#FF6B6B', "PM", font_name)
# 名字
draw.text((60, msg4_y - 5), "Product Manager", fill=text_gray, font=font_small)
# 消息气泡
msg4_text = "Great! Send it to group"
msg4_w = 200
msg4_h = 40
...
# 占位文字
draw.text((60, height - 32), "Type message...", fill=text_gray, font=font_small)
...
draw.text((width - 55, height - 32), "Send", fill='white', font=font_small)

# 保存图片
output_path = "/Volumes/My house/Users/Sheldon/.openclaw/workspace/mi-xin/03-内容工厂/3-配图成品区/02_body.png"
img.save(output_path, 'PNG')
print(f"Chat scene image saved: {output_path}")
