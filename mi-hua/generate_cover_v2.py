...
# 标题文字 - 使用英文
title = "Still Replying Manually?"
subtitle = "Molili AI Assistant"

# 主标题
draw.text((width//2 - 200, 280), title, fill='#333333', font=font_large)
draw.text((width//2 - 120, 330), subtitle, fill=tech_blue, font=font_medium)
